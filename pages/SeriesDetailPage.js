    ...
    const episodeHtml = seasonEpisodes
      ...
      <div class="seasons-episodes-item" tabindex="0" data-episode-index="${j}" data-episode-id="${episode.id
        ...
        <div class="episode-image-container">
          ...
          <!-- Progress Bar -->
          <div class="episode-progress-container" style="${progress == 0 ? "display: none;" : ""
          }">
        ...
        <div class="episode-info-container">
          <div class="episode-info-row-1">
            ...
            <div class="episode-title-wrapper">
                <span class="episode-title">${episode.title || `Episode ${episode.episode_num}`
          }</span>
            </div>
          ...
          <p class="episode-description">${episode.info.plot ||
          episode.plot ||
          seriesInfo.plot ||
...
const showCast = () => {
    ...
    const castHtml = castList
        ...
        <img src="${castMember.profile_path
          ...
          }" alt="${castMember.original_name || "Unknown"
          }" class="series-cast-item-image"
        onerror="this.src='/assets/placeholder-img.png'"/>
        <p class="series-cast-item-name">${castMember.original_name || "Unknown"
          }</p>
      </div>`
        )
        .join("");
...
function renderSeriesDetailPage(data) {
    ...
    // Add favorite button
    const isFavorite = isItemFavoriteForPlaylist(selectedSeriesItem.series_id, "favouriteSeries");
    buttonsHtml += `
                        ...
                        <div class="series-detail-info-div">
                            ...
                            <div class="seriesdetail-series-rating-time">
                                <p class="seriesdetail-rating">
                                    <img src="./assets/rating-star.png">${seriesInfo.rating_5based || "N/A"}
                                </p>
                            ...
                            <div class="seriesdetail-series-directed-and-genre">
                                <div>
                                    <p class="seriesdetail-directed"><span>Directed by:</span> ${seriesInfo.director || "N/A"}</p>
                                    <p class="seriesdetail-genre"><span>Genre:</span> ${seriesInfo.genre || "N/A"}</p>
                                </div>
                            </div>

                            <div>
                                <p class="seriesdetail-series-description">${seriesInfo.plot || "No description available."}</p>
                            </div>
