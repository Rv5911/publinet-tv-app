    ...
    <div class="login-page-container">
      <div class="login-form-div">
        ...
        <div class="login-inputs-div">
          <div><input class="playlistname-input  login-input"    type="text"  placeholder="Enter Any Name" value="jkjk"></div>
          <div><input class="username-input login-input"   type="text" placeholder="Enter User Name" value="testapp265"></div>
          <div><input class="password-input login-input" type="password"  placeholder="Enter Password"  value="MaJWZ7EmGC" ></div>
